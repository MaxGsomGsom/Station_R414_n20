...
/// <summary>
///   Ќастраивает станцию перед началом какого-либо задани€
/// </summary>
...
constructor TStationInitializer.Create(Station: TStation);
begin
  Inherited Create;
...
/// <summary>
///   ѕереводит станцию в 4-х проводный режим
/// </summary>
...
/// <summary>
///   ѕереводит станцию в 2-х проводный режим
/// </summary>
...
/// <summary>
///   √енерирует случайным образом значени€ волн приЄма/передачи
///   дл€ обоих полукомплектов и примен€ет их к станции
/// </summary>
...
/// <summary>
///   ¬ыставл€ет параметры станции дл€ выполнени€ задани€
/// <param name='TaskID'>ID задани€, дл€ которого требутс€
...
/// <summary>
///   ¬ыставл€ет параметры станции дл€ выполнени€ задани€
/// <param name='TaskType'>«адание, дл€ которого требутс€
///   подготовить станцию<param>
/// </summary>
...
/// <summary>
///   ¬ыполн€ет общую первоначальную инициализацию станции
/// </summary>
...
begin
  ...
  uBlockRemoteControllerForm.cbUdlinitel1.stKonez1.stKonez := csDisconected;
  uBlockRemoteControllerForm.cbUdlinitel1.stKonez2.stKonez := csDisconected;
  uBlockRemoteControllerForm.cbUdlinitel2.stKonez1.stKonez := csDisconected;
  ...
  {$REGION '»нициализаци€ параметров стоек случайными значени€ми'}
...
/// <summary>
///   Ќастраивает параметры станции дл€ выполнени€ задани€ StartParametersSetup
/// </summary>
...
/// <summary>
///   Ќастраивает параметры станции дл€ выполнени€ задани€ PowerOn
/// </summary>
...
/// <summary>
///   Ќастраивает параметры станции дл€ выполнени€ задани€ WorkWithLowFrequency
/// </summary>
...
{
/// <summary>
///   «агружает начальное состо€ние станции на момент начала задани€ (2.5k строк...)
/// </summary>
procedure LoadInitialState;
  var
    i: Byte;
