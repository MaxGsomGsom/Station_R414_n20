...
type pCallPassed = packed record
  ...
  function GetTransmitBlockTunedValue: Byte;
...
begin
  ...
  begin
    case Station.cbInputYY.stConnectedToPlaceId of
      0..168:
        begin
          //A
          case Station.cbInputYY.stConnectedToPlaceId  of
            15, 16:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240VTunedValue;
              end;
            17, 18:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240V2TunedValue;
              end;
            19, 20:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240V1TunedValue;
              end;
            21, 22:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240V2TunedValue;
              end;
            23, 24:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240V3TunedValue;
              end;
            25, 26:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240GTunedValue;
              end;
            27, 28:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G1TunedValue;
              end;
            71, 72:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G2TunedValue;
              end;
            73, 74:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G3TunedValue;
              end;
            75, 76:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G4TunedValue;
              end;
            77, 78:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240G1TunedValue;
              end;
            79, 80:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240G2TunedValue;
              end;
            81, 82:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240G3TunedValue;
              end;
            83, 84:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240G4TunedValue;
              end;
            127, 128:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G5TunedValue;
              end;
            129, 130:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G6TunedValue;
              end;
            131, 132:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G7TunedValue;
              end;
            133, 134:
              begin
                Result := Station.HalfSetA.Rack1200Left.sw1240G8TunedValue;
              end;
            135, 136:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240G5TunedValue;
              end;
            137, 138:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240G6TunedValue;
              end;
            139, 140:
              begin
                Result := Station.HalfSetA.Rack1200Right.sw1240G7TunedValue;
              end;
          end;
        end;
      169..336:
        begin
          ...
          case Station.cbInputYY.stConnectedToPlaceId of
            183, 184:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240VTunedValue;
              end;
            185, 186:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240V2TunedValue;
              end;
            187, 188:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240V1TunedValue;
              end;
            189, 190:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240V2TunedValue;
              end;
            191, 192:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240V3TunedValue;
              end;
            193, 194:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240GTunedValue;
              end;
            195, 196:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G1TunedValue;
              end;
            239, 240:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G2TunedValue;
              end;
            241, 242:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G3TunedValue;
              end;
            243, 244:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G4TunedValue;
              end;
            245, 246:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240G1TunedValue;
              end;
            247, 248:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240G2TunedValue;
              end;
            249, 250:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240G3TunedValue;
              end;
            251, 252:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240G4TunedValue;
              end;
            295, 296:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G5TunedValue;
              end;
            297, 298:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G6TunedValue;
              end;
            299, 300:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G7TunedValue;
              end;
            301, 302:
              begin
                Result := Station.HalfSetB.Rack1200Left.sw1240G8TunedValue;
              end;
            303, 304:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240G5TunedValue;
              end;
            305, 306:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240G6TunedValue;
              end;
            307, 308:
              begin
                Result := Station.HalfSetB.Rack1200Right.sw1240G7TunedValue;
              end;
          end;
        end;
    end;
...
function IsNeedToTuneChannelBlocksA: Boolean;
begin
  Result := Boolean((1 < Station.cbInputYY.stConnectedToPlaceId) and (Station.cbInputYY.stConnectedToPlaceId < 169));
end;

function IsNeedToTuneChannelBlocksB: Boolean;
begin
  Result := Boolean((168 < Station.cbInputYY.stConnectedToPlaceId) and (Station.cbInputYY.stConnectedToPlaceId < 337));
end;
