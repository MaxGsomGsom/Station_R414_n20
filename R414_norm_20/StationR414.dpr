...
uses
  ...
  uEducationForm in 'uEducationForm.pas' {EducationForm},
  ...
  uCreateUsersForm in 'uCreateUsersForm.pas' {CreateUsersForm},
  ...
  uAboutStationForm in 'uAboutStationForm.pas' {AboutStationForm},
