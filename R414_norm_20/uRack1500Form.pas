      ...
      begin
        ...
        begin
          ...
          try
            ...
            imgSwWave1610.OnMouseUp(TImage.Create(self), mbLeft, [], 0,0);
          except
      ...
      begin
        ...
        begin
          ...
          try
            ...
            imgSwWave1600R.OnMouseUp(TImage.Create(self), mbLeft, [], 0,0);
          except
            Application.MessageBox(PChar('Введите число от ' + IntToStr(MIN_WAVE_VALUE) + ' до ' + IntToStr(MAX_WAVE_VALUE) + '!'),
            PChar(PName), MB_OK + MB_ICONSTOP);
            Exit;
      ...
      begin
        ...
        begin
          ...
          try
            ...
            imgSwWave1500.OnMouseUp(TImage.Create(self), mbLeft, [], 0,0);
          except
            Application.MessageBox(PChar('Введите число от ' + IntToStr(MIN_WAVE_VALUE) + ' до ' + IntToStr(MAX_WAVE_VALUE) + '!'),
            PChar(PName), MB_OK + MB_ICONSTOP);
            Exit;
